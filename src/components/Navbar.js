...
const Navbar = () => {
  return (
    <div className="text-white h-24 items-center px-10 lg:px-20 flex md:space-x-72 md:justify-start justify-between font-semibold md:text-xl text-lg fixed top-0 bg-gray-900 w-full z-30">
      <div>
